...
const Teams = () => {
  return (
    ...
    >
      <Title
        title="Meet the team"
        desc="A passionae team of digital expert dedicated to your brand success."
      />
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-5">
        {teamData.map((team, index) => (
          <motion.div
            ...
            transtion={{ duration: 0.4, delay: index * 0.1 }}
            viewport={{ once: true }}
            key={index}
          ...
          >
            ...
            <div className="flex-1">
              <h3 className="front-bold-text-sm">{team.name}</h3>
